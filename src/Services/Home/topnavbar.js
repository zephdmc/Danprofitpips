            ...
            <div class="bg-black text-white px-6 py-4">
                <div class=" mx-auto flex flex-col md:flex-row px-6 md:px-[10%] justify-between items-center">
                    ...
                    <div class="flex mt-[4px] md:mt-0">
                        ...
                        <a href="https://wa.me/07067420349"  class="flex items-center mr-4">
                           <FaWhatsapp />
                        </a>
                        <a href="https://web.wechat.com/07067420349"  class="flex items-center mr-4">
                            <SiWechat />
                        </a>  <a href="https://twitter.com/capitalmoney007"  class="flex items-center mr-4">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
