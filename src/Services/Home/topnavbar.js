            ...
            <div class="bg-black text-white px-6 py-4">
                <div class=" mx-auto flex flex-col md:flex-row px-6 md:px-[10%] justify-between items-center">
                    ...
                    <div class="flex mt-[4px] md:mt-0">
                        <a href='https://www.facebook.com/profile.php?id=61554208622818https://www.facebook.com/profile.php?id=61554208622818' target="_blank" class="flex items-center mr-4">
                        ...
                        <a href="https://x.com/capitalmoney007" target="_blank" class="flex items-center mr-4">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://linkedin.com/uwa_daniel" target="_blank" class="flex items-center">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
