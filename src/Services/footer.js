    ...
    <footer className="bg-gray-800 text-gray-300 py-8">
      <div className=" mx-auto px-4">
        <div className="flex flex-wrap justify-between mx-[20%]">
          ...
          <div className="text-left w-full sm:w-1/2 md:w-1/4 mb-4">
            ...
            <ul className='text-left'>
              <li><a href="/Contact" className="hover:underline text-rose-600">Help Center</a></li>
              <li><a href="/About" className="hover:underline text-rose-600">About Us</a></li>
              <li><a href="/Contact" className="hover:underline text-rose-600">Contact Us</a></li>
            </ul>
          </div>
          {/* <div className="text-left w-full sm:w-1/2 md:w-1/4 mb-4">
            <h5 className="text-xl font-bold mb-2">Legal</h5>
            <ul>
              <li><a href="/Privacy" className="hover:underline text-rose-600">Privacy Policy</a></li>
              <li><a href="/Term" className="hover:underline text-rose-600">Terms of Service</a></li>
            </ul>
          </div> */}
          <div className="text-left w-full sm:w-1/2 md:w-1/4 mb-4">
            ...
            <ul className="flex space-x-4">
              <li>
                <a href="https://www.facebook.com/profile.php?id=61554208622818https://www.facebook.com/profile.php?id=61554208622818" aria-label="Facebook" className="hover:text-white">
          ...
          <div className="text-left w-full md:w-1/2 lg:w-1/4 mb-4">
            ...
            <form className="">
              ...
              <button
                type="submit"
                className="bg-rose-600 hover:bg-white hover:text-rose-600 text-white px-4 py-2 w-full rounded"
              >
                Sign Up
              </button>
            </form>
        ...
        <div className="text-center pt-4 border-t border-gray-700">
          <p>&copy; 2024 Danprofitpips. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
